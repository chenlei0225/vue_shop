  ...
  <div class="msite_shop_list">
    ...
    <div class="shop_container">
      <ul class="shop_list" v-if="shops.length>0">
        <li class="shop_li border-1px" @click="$router.push('/shop')" v-for="(shop,index) in shops" :key="shop.id">
          <a>
            <div class="shop_left">
...
<script>
  export default {
    ...
    mounted(){
      this.$store.dispatch('request_shops')
    },
    computed:{
      shops(){

        return this.$store.state.msite.shops
      }
    }
  }
</script>
