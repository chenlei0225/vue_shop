<template>
  <div class="shop-header">
    ...
    <div @click="isShowInfo=true" class="shop-content">
    ...
    <div @click="isShowSupport=true" class="shop-header-discounts" v-if="info.supports">
    ...
    <transition name="move">
      <div class="shop-brief-modal" v-if="isShowInfo">
      ...
      <div class="activity-sheet" v-if="isShowSupport">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">
            优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="color[support.type]" v-for="(support,index) in info.supports">
            <span class="content-tag">
...
<script>
  export default {
    ...
    computed:{
      info(){
        return this.$store.state.shop.info
      }
    }
  }
</script>
